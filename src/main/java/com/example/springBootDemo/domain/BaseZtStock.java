...
public class BaseZtStock implements Serializable {
    /**
     * 主键
     */
    ...
    private Float yesterdayAmplitude;

    /**
     * 换手
     */
    @Excel(name = "换手", orderNum = "10")
    private Float changingHands;

    /**
     * 昨日换手
     */
    @Excel(name = "昨日换手", orderNum = "13")
    private Float yesterdayChangingHands;
