...
public class LunarSolarUtil {
     ...
     * 阳历日期转阴历日期
     * 入参要有年月日数据，出参只有月日数据
     * 比如 data 2023-09-02 会转成 data 2023-07-18
     */
    public static Date getLunarDate(Date date) {
        ...
        solar.solarDay = calendar.get(Calendar.DATE);

        Lunar lunar = LunarSolarUtil.SolarToLunar(solar);

        return calendarToData(lunar.getLunarYear(), lunar.getLunarMonth(), lunar.getLunarDay());
    }
     ...
     * 阳历日期转阴历日期
     * 入参要有年月日数据，出参只有月日数据
     * 比如 String 2023-09-02 会转成 String 2023-07-18
     */
...
//        Lunar lunar = LunarSolarUtil.SolarToLunar(solar);
        ...
        System.out.println(LunarSolarUtil.getLunarDate(new Date()));
        System.out.println(LunarSolarUtil.getLunarDateStr("2023-09-03"));
...
//        l.lunarYear = 2100;
//
//        solar = LunarSolarUtil.LunarToSolar(l);
//        System.out.println(dump(solar));
//        System.out.println(LunarSolarUtil.lunarYearToGanZhi(2023));
    }
}
